...
public class CLS {
    public static void main(String[] args) {
        ...
        // 16. Магическим квадратом порядка n называется вадратная матрица размера NxN, составленная
        // из чисел 1,2,3...,pow(n,2) так, суммы по каждому столбцу, каждой строке и каждой из двух
        // больших диагоналей равны между собой. Построить такой квадрат. Примерагического квадрата порядка 3.
        //     6  1  8
        //     7  5  3
        //     2  9  4
